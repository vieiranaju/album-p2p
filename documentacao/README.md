...
Você pode baixar o template da figurinha [aqui](images/FIG-XX.png).
...
| Identificador do nó | `peer_id` no formato `ALUNO-YY` (ex.: `ALUNO-02`). [Seguindo a lista de chamada](LISTA-CHAMADA.md) |
...
| Mensagem | Descrição | Referência |
|---|---|---|
| `HELLO` | Anuncia a presença de um nó para um vizinho. | [PROTOCOLO-HELLO.md](PROTOCOLO-HELLO.md) |
| `SEARCH` | Busca uma figurinha específica na rede. | [PROTOCOLO-SEARCH.md](PROTOCOLO-SEARCH.md) |
| `SEARCH_HIT` | Resposta positiva informando que a figurinha foi encontrada. | [PROTOCOLO-SEARCH_HIT.md](PROTOCOLO-SEARCH_HIT.md) |
| `SEARCH_MISS` | Resposta opcional de não encontrada no nó local. | [PROTOCOLO-SEARCH_MISS.md](PROTOCOLO-SEARCH_MISS.md) |
| `TRADE_OFFER` | Propõe uma troca. | [PROTOCOLO-TRADE_OFFER.md](PROTOCOLO-TRADE_OFFER.md) |
| `TRADE_ACCEPT` | Aceita a troca proposta. | [PROTOCOLO-TRADE_ACCEPT.md](PROTOCOLO-TRADE_ACCEPT.md) |
| `TRADE_REJECT` | Rejeita a troca proposta. | [PROTOCOLO-TRADE_REJECT.md](PROTOCOLO-TRADE_REJECT.md) |
| `TRANSFER_CONFIRM` | Confirma a atualização do inventário após a troca. | [PROTOCOLO-TRANSFER_CONFIRM.md](PROTOCOLO-TRANSFER_CONFIRM.md) |
